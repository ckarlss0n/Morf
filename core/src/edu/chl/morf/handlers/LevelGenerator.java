	...
	public void generateLevel(Level level, World world, Map<Body, Water> bodyBlockMap){
		...
		for (LevelObject object : level.getMatrix().getLevelObjects()){
			if (object.getTileType() == TileType.GROUND){
				...
				ChainShape chainShape = new ChainShape();
				Vector2[] v = new Vector2[5];
				v[0] = new Vector2(-TILE_SIZE*0.8f / 2 / PPM, -TILE_SIZE / 2 / PPM);
				v[1] = new Vector2(-TILE_SIZE*0.8f / 2 / PPM, TILE_SIZE * 0.2f / 2 / PPM);
				v[2] = new Vector2(TILE_SIZE*0.8f / 2 / PPM, TILE_SIZE * 0.2f/ 2 / PPM);
				v[3] = new Vector2(TILE_SIZE*0.8f / 2 / PPM, -TILE_SIZE / 2 / PPM);
				v[4] = new Vector2(-TILE_SIZE*0.8f / 2 / PPM, -TILE_SIZE / 2 / PPM);
